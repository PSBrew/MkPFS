...
5. **Git**: Always use the `pr-and-commit-writing` skill for commit messages and PRs. Follow its rules: commit messages use short natural-language titles (≤50 chars); PR titles are simple, release‑note‑ready sentences without Conventional Commit prefixes.
